    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Form Ubah Transaksi</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <?php
include "koneksi.php";
$qry_get_pembayaran=mysqli_query($conn,"select * from pembayaran,siswa,spp where pembayaran.nisn=siswa.nisn and
siswa.id_spp=spp.id_spp and pembayaran.id_pembayaran='$_GET[id_pembayaran]'");
$dt_pembayaran=mysqli_fetch_array($qry_get_pembayaran);
?>
<form action="proses_ubah_transaksi.php" method="post">
                ...
                <section id="basic-horizontal-layouts">
                    ...
                    placeholder="Masukkan Nama Siswa" name="namadisabled" value="<?php echo $dt_pembayaran['nama'];?>" disabled >

                    <input type="hidden" class="form-control" id="nama" placeholder="Masukkan Nama Siswa" name="nama"  
                    value="<?php echo $dt_pembayaran['nama'];?>" >
                                                        </div>
                                                        <div class="col-md-4">
    ...
    <option value="Desember">Desember</option>
                                                    ...
                                                    <td><a href="tampil_transaksi.php" class="btn btn-outline-primary">Kembali</a>
