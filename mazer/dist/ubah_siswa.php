                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Form Ubah Siswa</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section id="basic-horizontal-layouts">
                    <div class="row match-height">
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" name="nisn" value="<?=$dt_siswa['nisn']; ?>" disabled class="form-control">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                    <input type="text" name="nis" value="<?=$dt_siswa['nis']; ?>" class="form-control" placeholder="NIS">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label>Nama Siswa</label>
                                                    </div>
                                                    <div class="col-md-8 form-group">
                                                    <input type="text" name="nama" value="<?=$dt_siswa['nama']; ?>" class="form-control" placeholder="Nama Siswa">
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                    <select name="id_kelas" value="<?=$dt_siswa['id_kelas']; ?>" class="form-control" placeholder="Kelas">
                        <?php
                        include "koneksi.php";
                        ...
                        ?>
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                    <input type="text" name="alamat" value="<?=$dt_siswa['alamat']; ?>" class="form-control" placeholder="Alamat">
                                                    </div>
                                                    <div class="col-md-4">
                                                    <label>NO TELP</label>
                                                    </div>
                                                    <div class="col-md-8 form-group">
                                                    <input type="text" name="no_telp" value="<?=$dt_siswa['no_telp']; ?>" class="form-control" placeholder="No Telp">
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <td><a href="tampil_siswa.php" class="btn btn-outline-primary">Kembali</a>
