                                        ...
                                        <form class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                    <input type="text" name="kompetensi_keahlian" value="<?=$dt_kelas['kompetensi_keahlian']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col-md-4">
                                                        
                                                    </div>
                                                    <div class="col-sm-12 d-flex justify-content-end">
                                                    <td><a href="tampil_kelas.php" class="btn btn-outline-primary">Kembali</a>
