    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Form Tambah SPP</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <form action="proses_spp.php" method="post">
                                        ...
                                        <form class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <input type="text" name="tahun" value="" class="form-control" placeholder="Tahun">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label>Nominal</label>
                                                    </div>
                                                    <div class="col-md-8 form-group">
                                                    <input type="text" name="nominal" value="" class="form-control" placeholder="Nominal">
                                                    </div>
                                                    <div class="col-md-4">
