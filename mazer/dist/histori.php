...
<br/>
    ...
    <!-- Kita tampilkan Biodata Siswa -->
        ...
        <table class="table table-hover table-striped">
            <thead>
            <tr>
                <th>No. </th><th>Tanggal Pembayaran</th><th>Pembayaran Melalui</th><th>Tahun SPP | Nominal yang harus dibayar</th><th>Bulan</th><th>Jumlah yang sudah dibayar</th><th>Status</th>
            </tr>
</thead>
<hr/>
...
<a href="cetak.php?nisn=<?=$r_siswa['nisn']?>" button class="btn btn-primary" type="submit" target="_blank">CETAK</button></a>   
    <?php  } ?>
