...
<body>
 ...
 <thead>
 <tr>
 <th>NO</th><th>TAHUN</th><th>NOMINAL</th><th>AKSI</th>
 </tr>
 </thead>
 <tbody>
 <?php
...
<td><a href="ubah_spp.php?id_spp=<?=$data_spp['id_spp']?>" button type="button" class="btn btn-outline-primary">Ubah</button></a> 
| <a href="hapus_spp.php?id_spp=<?=$data_spp['id_spp']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" button type="button" class="btn btn-outline-danger">Hapus</button></td>
</tr>
...
<td><a href="tambah_spp.php"  button class="btn btn-primary" type="submit">Tambah SPP</a>
                                </div>
                            </div>
                        </div>
                    </div>
