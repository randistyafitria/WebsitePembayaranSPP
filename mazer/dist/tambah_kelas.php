                                        ...
                                        <form class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <input type="text" name="nama_kelas" value="" class="form-control" placeholder="Nama Kelas">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label>Kompetensi Keahlian</label>
                                                    </div>
                                                    <div class="col-md-8 form-group">
                                                    <input type="text" name="kompetensi_keahlian" value="" class="form-control" placeholder="Kompetensi Keahlian">
                                                    </div>
                                                    <div class="col-md-4">
